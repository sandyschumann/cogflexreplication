...
safeself <- subset(fulldataset, choice==1) #select those who chose to safe themselves
...
sacrifice <- subset(fulldataset, choice==2) #select those who chose to self-sacrifice
