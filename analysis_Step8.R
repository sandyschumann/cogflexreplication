...
fullmodel11mod<-'##regressions
            ...
            ##intercepts            
            die~1'
fitfull11mod <- sem(fullmodel11mod, data = fulldataset, estimator = "MLR", missing = "FIML")
...
mediatedmodel11mod<-'##regressions
              ...
              die~1
              fight~1'
fitmediated11mod <- sem(mediatedmodel11mod, data = fulldataset, estimator = "MLR", missing = "FIML")
...
CFA_model1fit <- cfa(CFA_model1, data=fulldataset, estimator = "MLM")
...
CFA_model1b<- 'progroup_behaviour =~ killandfight_1+killandfight_2+killandfight_3+killandfight_4+killandfight_5+die
              ##covariances
              ...
              killandfight_3 ~~ die
              killandfight_1 ~~ die'
CFA_model1bfit <- cfa(CFA_model1b, data=fulldataset, estimator = "MLM")
...
CFA_model2b<- '##latent factors willingness to fight and die
              ...
              ##covariances
              killandfight_2 ~~ killandfight_3'
CFA_model2bfit <- cfa(CFA_model2b, data=fulldataset, estimator = "MLM")
...
cor.test(fulldataset$fightdie, fulldataset$RATaccuracy, use = "complete.obs", method = "spearman")
cor.test(fulldataset$fightdie, fulldataset$WCSTaccuracy, use = "complete.obs", method = "spearman")
...
fullmodel14<-'##regressions
            ...
            ##intercepts            
            fightdie~1'
fitfull14 <- sem(fullmodel14, data = fulldataset, estimator = "MLR", missing = "FIML")
summary(fitfull14, fit.measures = TRUE, standardized = TRUE)
modindices(fitfull14, sort = TRUE, maximum.number = 10)
...
fullmodel14mod<-'##regressions
            ...
            ##intercepts            
            fightdie~1'
fitfull14mod <- sem(fullmodel14mod, data = fulldataset, estimator = "MLR", missing = "FIML")
...
fullmodel13mod<-'##regressions
            ...
            ##intercepts            
            ARIS~1'
fitfull13mod <- sem(fullmodel13mod, data = fulldataset, estimator = "MLR", missing = "FIML")
summary(fitfull13mod, fit.measures = TRUE, standardized = TRUE)
inspect(fitfull13mod, 'r2') #inspect explained variance

###Correlations CFI subscales and RAT and WCST
cor.test(fulldataset$Alternatives, fulldataset$RATaccuracy, use = "complete.obs", method = "spearman")
cor.test(fulldataset$Control, fulldataset$RATaccuracy, use = "complete.obs", method = "spearman")
cor.test(fulldataset$Alternatives, fulldataset$WCSTaccuracy, use = "complete.obs", method = "spearman")
cor.test(fulldataset$Control, fulldataset$WCSTaccuracy, use = "complete.obs", method = "spearman")
